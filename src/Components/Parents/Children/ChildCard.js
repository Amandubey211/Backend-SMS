    ...
    <>
      <div className="bg-white rounded-md p-4 flex flex-col justify-between h-full border">
        ...
        <div className="grid grid-cols-2 gap-2 mt-4">
          ...
          <button
            onClick={onOpenHealthSidebar}
            className="flex items-center justify-center space-x-2 py-2 rounded bg-orange-100 hover:bg-purple-200 transition"
          >
            <MdHealthAndSafety />
          ...
          <button
            onClick={(e) => {
              e.stopPropagation();
              handleOpenReportCardModal(student);
            }}
            className="flex items-center justify-center space-x-2 py-2 rounded bg-yellow-100 hover:bg-purple-200 transition"
          >
            <BiSpreadsheet />
