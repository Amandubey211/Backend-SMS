        ...
        <div className="relative w-96 h-70 rounded-lg overflow-hidden shadow-md border border-gray-200 p-4 m-2 flex flex-col items-center transition-transform duration-300 hover:scale-105 hover:shadow-lg bg-white">
            <div className="w-full flex flex-col items-center">
                ...
                <div className="text-center">
                    <p className="text-gray-900 text-lg font-semibold">{instructor.name}</p>
                    <p className="text-gray-500 font-semibold text-sm">{instructor.role}</p>
                    <p className="text-gray-500 font-semibold text-sm">{instructor.department}</p>
                </div>
                <div className="flex flex-col items-center mt-3 mb-2">
                    <span className="text-gray-700 text-sm">Phone:</span>
                    <span className="text-gray-500 font-semibold text-sm">{instructor.phone}</span>
                    <span className="text-gray-500 font-semibold text-sm">{instructor.email}</span>
                </div>
            </div>
        </div>
    );
