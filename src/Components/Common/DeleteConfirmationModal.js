...
const DeleteConfirmatiomModal = ({ isOpen, onClose, onConfirm, loading }) => {
  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        <div className="p-4">
          <p id="logout-modal-description">Are you sure you want to Delete it?</p>
...
DeleteConfirmatiomModal.propTypes = {
...
export default DeleteConfirmatiomModal;
