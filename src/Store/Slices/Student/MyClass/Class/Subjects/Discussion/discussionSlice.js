...
const discussionSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(editStudentDiscussionComment.fulfilled, (state, action) => {
    ...
    builder.addCase(editStudentDiscussionReply.fulfilled, (state, action) => {
      const index = state.comments.findIndex(
        (comment) => comment._id === action.payload._id
      );
      if (index !== -1) {
    ...
    builder.addCase(createStudentDiscussionReply.fulfilled, (state, action) => {
