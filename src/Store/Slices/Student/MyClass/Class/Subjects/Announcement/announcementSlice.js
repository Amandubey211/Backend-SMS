...
import { createStudentAnnounceComment, createStudentAnnounceReply, editStudentAnnounceComment, editStudentAnnounceReply, fetchStudentAnnounce, fetchStudentAnnounceById, fetchStudentAnnounceComments } from "./announcement.action"
...
const announcementSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder
            .addCase(editStudentAnnounceComment.fulfilled, (state, action) => {
        ...
        builder
            .addCase(editStudentAnnounceReply.fulfilled, (state, action) => {
                const index = state.comments.findIndex(
                    (comment) => comment._id === action.payload._id
                );
                if (index !== -1) {
        ...
        builder
            .addCase(createStudentAnnounceReply.fulfilled, (state, action) => {
