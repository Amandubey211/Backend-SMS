...
export const fetchAllReceipts = createAsyncThunk(
  ...
  async ({ page, limit,search,isCancel,status}, { dispatch, rejectWithValue, getState }) => {
    ...
    try {
      ...
      const response = await getData(`/${getRole}/all/receipt`,{ page, limit,search,isCancel,status});
