...
i18n
  ...
  .init({
    ...
    ns: ['date','month','language','setting','stdFinance','stdLibrary','stdNoticeboard','stdEvents','stdSyllabus', 'prtFinance', 'prtChildrens', 'prtNotices', 'prtEvents', 'prtLibrary'], // Specify your namespace
