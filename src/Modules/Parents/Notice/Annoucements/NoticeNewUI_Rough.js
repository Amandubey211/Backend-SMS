              ...
              filteredNotices.map((notice, index) => (
                ...
                >
                  ...
                  <div className="pr-3 flex-shrink-0">
                    <div
                      className="h-16 w-16 rounded-md flex items-center justify-center transition-all duration-300 scale-110 shadow-md"
                  ...
                  <div className="flex flex-col justify-between flex-grow">
                    <div>
                      ...
                      <div className="flex items-center gap-1 text-gray-500 mt-2">
                        ...
                        <p className="text-xs m-0 leading-4">{truncateText(notice?.description, 100)}</p>
                      </div>
                    </div>
                  </div>
                </div>
