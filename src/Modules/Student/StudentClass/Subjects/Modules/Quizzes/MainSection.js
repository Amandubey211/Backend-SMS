...
//   useFetchAttemptHistory(quizId, allowNumberOfAttempts, setAttemptHistory, setQuizSubmitted);

//   // Custom hook to handle quiz submission
//   const {submitQuiz} = useSubmitQuiz(quizId, attemptHistory, setAttemptHistory, allowNumberOfAttempts);
...
//     const newAttempt = await submitQuiz(questionsWithSelectedOptions, totalTime - timeLeft);
...
//     return allowNumberOfAttempts === 0 || attemptHistory.length < allowNumberOfAttempts;
//   };
...
//               {activeTab === "instructions" && <QuizInstructionSection quiz={quiz} />}
//               {activeTab === "questions" && (
//                 <>
