...
import AddRubricModal from '../Modules/Rubric/Components/AddRubricModal';
import Sidebar from '../Modules/Rubric/Components/Sidebar';
import AddNewCriteriaForm from '../Modules/Rubric/Components/AddNewCriteriaForm';
import { useTranslation } from 'react-i18next';

const CreateModalHeader = ({ onSave }) => {
    ...
    <div className="flex items-center justify-between p-4 bg-white border-b border-gray-300 shadow-sm">
      ...
      <div className="flex items-center space-x-2">
        ...
        >
          ...
          <span>{t("Add Rubric")}</span>
        </button>
        <button
          onClick={() => {
            onSave();
            toast.success(t("Saved and Published"), { position: "bottom-left" });
          }}
