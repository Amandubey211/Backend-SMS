...
const AnnouncementCommentsHeader = ({ handleSearch, handleRefresh }) => {
  return (
    <div className="flex items-center gap-2 p-4 bg-white w-full border-b h-full relative">
...
export default AnnouncementCommentsHeader;
