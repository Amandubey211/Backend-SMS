      ...
      <table className="min-w-full border divide-y divide-gray-200">
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {filteredData?.map((item, index) => (
            <tr key={index}>
              <td
                className={`px-6 py-4 whitespace-nowrap ${getBoldClass(item)}`}
              >
              ...
              <td
                className={`px-6 py-4 whitespace-nowrap text-sm text-gray-500 ${getBoldClass(
                  item
                )}`}
              >
              ...
              <td
                className={`px-6 py-4 whitespace-nowrap text-sm ${getBoldClass(
                  item
