  ...
  return (
    <div className="relative flex flex-col border w-44 p-2 rounded-sm shadow-sm">
      ...
      <div className="flex flex-col items-start p-1 pt-8">
        <p className="font-medium text-gray-700">{rating.markType}</p>
        <p className="text-sm font-bold pb-2 text-purple-600">{rating.points}</p>
        <hr className="w-full"/>
        <p className="text-xs p-2 text-gray-500">{rating.description}</p>
      </div>
    </div>
  );
};
...
const RatingCard = ({ rating, onDeleteRating, onEditRating }) => {
  return (
    <div className="relative flex flex-col border w-44 h-40 p-2 rounded-sm shadow-sm">
      ...
      <div className="flex flex-col items-start p-1 pt-8">
        ...
        <p className="text-sm font-bold pb-2 text-purple-600">{rating.ratingScore}</p>
        <hr className="w-full"/>
