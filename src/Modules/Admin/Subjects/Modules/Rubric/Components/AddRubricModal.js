...
const AddRubricModal = ({ criteria, isOpen, onClose, onAddCriteria, onDeleteCriteria }) => {
  useEffect(() => {
    if (isOpen) {
      ...
      >
        ...
        <div className="m-2 overflow-auto border h-[47vh]">
          <div className="flex px-4 font-semibold justify-between items-center p-2 w-full  bg-gradient-to-r from-pink-100 to-purple-100">
            <div className="w-2/8 bg-gradient-to-r from-red-500 to-purple-500 bg-clip-text text-transparent">
              Criteria
            </div>
            <div className="w-2/8 bg-gradient-to-r from-red-500 to-purple-500 bg-clip-text text-transparent">
              Ratings
