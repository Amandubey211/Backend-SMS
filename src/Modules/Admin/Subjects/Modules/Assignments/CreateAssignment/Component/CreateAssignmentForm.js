...
import AssignToRadios from './AssignToRadios';
...
const CreateAssignmentForm = ({
  ...
  return (
    <div className="max-w-sm mx-auto p-6 bg-white border">
      ...
      <SubmissionTypeRadios submissionType={submissionType} handleChange={handleChange} />
      <AllowedAttemptsSelect allowedAttempts={allowedAttempts} handleChange={handleChange} />
      <NumberOfAttemptsInput numberOfAttempts={numberOfAttempts} handleChange={handleChange} />
      ...
      <DateInput label="Due" name="dueDate" value={dueDate} handleChange={handleChange} />
      <DateInput label="Available from" name="availableFrom" value={availableFrom} handleChange={handleChange} />
      <DateInput label="Until" name="until" value={until} handleChange={handleChange} />
