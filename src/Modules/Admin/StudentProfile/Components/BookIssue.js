        ...
        <table className="min-w-full leading-normal mt-4 shadow-lg rounded-lg overflow-hidden">
          <thead>
            <tr className="text-left text-gray-700 bg-gray-100">
              ...
              <th className="px-5 py-3 border-b-2 border-gray-200">Return Date</th>
          ...
          <tbody>
            {filteredData.map((book, index) => (
              <tr key={index} className="bg-white">
                ...
                <td className="px-5 py-2 border-b border-gray-200"> <div className="flex items-center">
                  <img
                ...
                <td className="px-5 py-2 border-b border-gray-200">{book.author}</td>
                <td className="px-5 py-2 border-b border-gray-200">{book.category}</td>
                <td className="px-5 py-2 border-b border-gray-200">{book.issueDate}</td>
                <td className="px-5 py-2 border-b border-gray-200">{book.returnDate}</td>
                <td className="px-5 py-2 border-b border-gray-200">
                  <span className={`px-3 py-1 text-xs font-semibold rounded-full ${
                    book.status === "Return" ? "bg-green-200 text-green-800" : "bg-red-200 text-red-800"
                  }`}>
                    {book.status}
                  </span>
                </td>
