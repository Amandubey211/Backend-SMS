  ...
  return (
    <div className="flex flex-col items-center p-3 py-5 gap-2 justify-center">
      ...
      <div className="flex gap-4 font-medium text-gray-500 flex-row text-sm ">
        <span className="text-black">Class: <span className="text-gray-500" >{student?.className}</span> <span className="text-gray-300">|</span> </span> 
        <span className="text-black">Section: <span className="text-gray-500" >{student?.sectionName}</span></span>
      </div>
