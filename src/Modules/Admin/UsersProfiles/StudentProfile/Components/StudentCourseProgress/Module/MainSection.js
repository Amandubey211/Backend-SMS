        ...
        <div className="bg-white p-4 rounded-lg">
          ...
          <div className="grid grid-cols-1 gap-2">
            {modules?.map((module, index) => (
              <div onClick={() => selectModule(module)} className={`cursor-pointer `} >
                <div className={`relative mb-4 border-gradient bg-white rounded-lg shadow-md ${seletedModuleId == module.moduleId  ? 'border border-pink-500 rounded-lg' : null}`}>
