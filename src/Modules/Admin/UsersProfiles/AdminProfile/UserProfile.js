        ...
        <DashLayout>
          <div className="flex flex-col  w-full p-4 gap-3 ">
            <div className="flex items-center px-6 py-4 gap-3 border rounded-md">
              <img
                src={userData.profiles ? userData?.profile : profileIcon}
                alt="Cameron Williamson"
                className="w-20 h-20 rounded-full shadow-lg border "
              />
              <div className="flex flex-row justify-between w-full">
                <h2 className="text-xl font-semibold">{userData.adminName}</h2>
                <button
            ...
            <div className="flex flex-row gap-28 px-6 py-8 border items-center rounded-md">
              ...
              <div className="flex flex-col gap-5">
                <div className="flex flex-col">
                  ...
                  <span className="font-medium text-gray-800">
                    {userData?.adminName?.split(' ')[1] ? userData.adminName.split(' ')[1] : '-'}
                  </span>
                </div>
                <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-10 p-6 py-13 border rounded-md">
             ...
             <input
              ...
              /> <span className="text-2xl cursor-pointer">{!showPaasword?<FaEye onClick={()=>setShowPassword(true)}  />:<FaEyeSlash onClick={()=>setShowPassword(false)}  />}</span>
             </div>
              <input
                type="password"
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="px-4 w-[200px] h-12 inline-flex items-center border border-transparent text-sm font-medium shadow-sm bg-gray-300 text-black rounded-md hover:bg-gray-400"
                >
                  Cancel
                </button>
              </div>
