  ...
  return (
    <div className="flex flex-col gap-4 mt-2">
      {children?.map((child, index) => (
        <div
          key={index}
          className="flex flex-col text-center border border-gray-300 rounded-md items-center justify-around mx-5 py-5 gap-3"
        >
          <div>
            <img
          ...
          <div>
            ...
            <ProtectedAction requiredPermission={PERMISSIONS.SHOW_STUDENT_INFO}>
              <button
