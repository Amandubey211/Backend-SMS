...
export const initialValues = {
  candidateInformation: {
    ...
    middleName: "Marie",
    lastName: "Johnson",
    dob: "2004-10-21", // Format: YYYY-MM-DD
    gender: "female",
    ...
    passportExpiry: "2032-11-20", // Format: YYYY-MM-DD
    studentId: "STU10001",
    idExpiry: "2026-01-01", // Format: YYYY-MM-DD
    nativeLanguage: "English",
    primaryContact: "Mother",
    phoneNumber: "+14151234567",
    email: "alice.johnson@example.com",
    emergencyNumber: "+14159876543",
    age: "20",
  },
  academicSession: {
    academicYear: "2023-2024",
    class: "Grade 11",
    enrollmentStats: "Part Time",
  },
  academicHistory: {
    previousSchoolName: "Sunset High School",
    previousClass: "Grade 10",
    curriculum: "IB",
    lastDayAtSchool: "2023-05-31", // Format: YYYY-MM-DD
    sourceOfFee: "Scholarship",
  },
  languagePrefs: {
    second: ["Mandarin", "French"],
    third: ["Spanish"],
    valueEd: "Islamic",
    leftHanded: true,
  },
  ...
  addressInformation: {
    ...
    buildingNumber: "88",
    streetNumber: "45",
    streetName: "Riverdale St.",
    zone: "East",
    dwellingType: "standAlone",
    compoundName: "Willow Grove",
    city: "Vancouver",
    nearestLandmark: "Stanley Park",
    proposedCampus: "North Campus",
  ...
  fatherInfo: {
    idNumber: "F987654321",
    idExpiry: "2036-12-01", // Format: YYYY-MM-DD
    fatherPhoto: null,
    firstName: "Robert",
    middleName: "Thomas",
    lastName: "Johnson",
    ...
    cell1: { value: "+14152345678", isWhatsapp: true },
    cell2: { value: "+14152349876", isWhatsapp: false },
    email1: "robert.johnson@techcorp.com",
    email2: "robert.johnson@gmail.com",
    workPhone: "+14152349877",
    homePhone: "+14152346789",
  },
  motherInfo: {
    idNumber: "M123456789",
    profileImage: null,
    ...
    company: "HealthPlus",
    jobTitle: "Nurse",
    cell1: { value: "+14152341122", isWhatsapp: true },
    cell2: { value: "+14152341123", isWhatsapp: false },
    workPhone: "+14152341125",
    homePhone: "+14152341126",
    email1: "laura.johnson@healthplus.com",
    email2: "laura.johnson@gmail.com",
  },
  guardianInformation: {
    guardianName: "Emily Davis",
    guardianRelationToStudent: "Aunt",
    guardianContactNumber: "+14152341127",
    guardianEmail: "emily.davis@example.com",
  },
  profile: null, // Placeholder for profile picture file
};
