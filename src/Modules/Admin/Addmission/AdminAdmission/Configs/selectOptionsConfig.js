...
export const RELIGION_OPTIONS = [
  {
    label: "Adventist (Seventh‑day Adventist)",
    value: "adventist-seventh-day-adventist",
  },
  {
  ...
  { label: "Ainu Spirituality", value: "ainu-spirituality" },
  { label: "Akan Religion", value: "akan-religion" },
  { label: "Alevi", value: "alevi" },
  { label: "Amish", value: "amish" },
  { label: "Anglicanism", value: "anglicanism" },
  { label: "Animism", value: "animism" },
  { label: "Apostolic Pentecostal", value: "apostolic-pentecostal" },
  { label: "Armenian Apostolic", value: "armenian-apostolic" },
  { label: "Asatru / Heathenry", value: "asatru-heathenry" },
  {
  ...
  { label: "Brethren (Plymouth)", value: "brethren-plymouth" },
  { label: "Buddhism", value: "buddhism" },
  { label: "Candomblé", value: "candomble" },
  { label: "Cao Dai", value: "cao-dai" },
  { label: "Calvinism / Reformed", value: "calvinism-reformed" },
  { label: "Catharism", value: "catharism" },
  { label: "Celtic Neopaganism", value: "celtic-neopaganism" },
  { label: "Chaldean Catholic", value: "chaldean-catholic" },
  { label: "Chan (Zen) Buddhism", value: "chan-zen-buddhism" },
  { label: "Cheondoism", value: "cheondoism" },
  { label: "Chinese Folk Religion", value: "chinese-folk-religion" },
  { label: "Christian Science", value: "christian-science" },
  { label: "Christianity", value: "christianity" },
  { label: "Church of God (Cleveland)", value: "church-of-god-cleveland" },
  { label: "Church of Jesus Christ of Latter‑day Saints", value: "lds-mormon" },
  { label: "Church of Nazarene", value: "church-of-nazarene" },
  { label: "Confucianism", value: "confucianism" },
  { label: "Congregationalism", value: "congregationalism" },
  { label: "Coptic Orthodox", value: "coptic-orthodox" },
  { label: "Deism", value: "deism" },
  { label: "Druidry (Neo‑Druidism)", value: "neo-druidism" },
  { label: "Druze", value: "druze" },
  { label: "Eastern Catholic", value: "eastern-catholic" },
  { label: "Eastern Orthodoxy", value: "eastern-orthodoxy" },
  { label: "Eckankar", value: "eckankar" },
  { label: "Essene Movement", value: "essene-movement" },
  { label: "Evangelicalism", value: "evangelicalism" },
  { label: "Falun Gong", value: "falun-gong" },
  { label: "Foursquare Church", value: "foursquare-church" },
  { label: "Gnosticism", value: "gnosticism" },
  { label: "Greek Catholic", value: "greek-catholic" },
  { label: "Greek Orthodox", value: "greek-orthodox" },
  { label: "Hare Krishna (ISKCON)", value: "hare-krishna" },
  { label: "Hellenism (Hellenic Reconstruction)", value: "hellenism" },
  { label: "Hinduism", value: "hinduism" },
  { label: "Huangdi Worship", value: "huangdi-worship" },
  { label: "Humanism (Secular)", value: "secular-humanism" },
  { label: "Iglesia ni Cristo", value: "iglesia-ni-cristo" },
  { label: "Ifá / Yoruba", value: "ifa-yoruba" },
  {
    label: "Indigenous Australian Spirituality",
    value: "indigenous-australian-spirituality",
  },
  { label: "Indigenous Colombian Muisca Religion", value: "muisca-religion" },
  { label: "Indigenous Mexican Nahua Religion", value: "nahua-religion" },
  { label: "Iranian Zoroastrianism", value: "iranian-zoroastrianism" },
  { label: "Islam", value: "islam" },
  { label: "Jainism", value: "jainism" },
  { label: "Jehovah’s Witnesses", value: "jehovahs-witnesses" },
  { label: "Juche", value: "juche" },
  { label: "Judaism", value: "judaism" },
  { label: "Kabyle (Berber) Islam", value: "kabyle-islam" },
  { label: "Kemetic Orthodoxy", value: "kemetic-orthodoxy" },
  { label: "Kʼicheʼ Maya Religion", value: "kiche-maya-religion" },
  { label: "Korean Shamanism", value: "korean-shamanism" },
  { label: "LaVeyan Satanism", value: "laveyan-satanism" },
  { label: "Lutheranism", value: "lutheranism" },
  { label: "Mahikari", value: "mahikari" },
  { label: "Mandaeism", value: "mandaeism" },
  { label: "Marcionism", value: "marcionism" },
  { label: "Maronite Catholic", value: "maronite-catholic" },
  { label: "Messianic Judaism", value: "messianic-judaism" },
  { label: "Methodism", value: "methodism" },
  { label: "Miaphysite Christianity", value: "miaphysite-christianity" },
  { label: "Mithraism (Revival)", value: "mithraism" },
  { label: "Moravian Church", value: "moravian-church" },
  { label: "Nation of Islam", value: "nation-of-islam" },
  { label: "Native American Church", value: "native-american-church" },
  { label: "Neo-Paganism", value: "neo-paganism" },
  { label: "Nestorianism", value: "nestorianism" },
  { label: "New Apostolic Church", value: "new-apostolic-church" },
  { label: "New Thought", value: "new-thought" },
  { label: "Nichiren Buddhism", value: "nichiren-buddhism" },
  { label: "Noahidism", value: "noahidism" },
  {
    label: "Old Believers (Russian Orthodox Old‑Rite)",
    value: "old-believers",
  },
  { label: "Open Brethren", value: "open-brethren" },
  { label: "Orphism (Hellenic)", value: "orphism" },
  { label: "Orthodox Judaism", value: "orthodox-judaism" },
  { label: "Paganism (General)", value: "paganism" },
  { label: "Palmarian Catholic Church", value: "palmarian-catholic-church" },
  { label: "Pentecostalism", value: "pentecostalism" },
  { label: "Plymouth Brethren", value: "plymouth-brethren" },
  { label: "Presbyterianism", value: "presbyterianism" },
  { label: "Protestantism", value: "protestantism" },
  { label: "Quaker (Religious Society of Friends)", value: "quaker" },
  { label: "Rastafarianism", value: "rastafarianism" },
  { label: "Raëlian Movement", value: "raelian-movement" },
  { label: "Reformed Judaism", value: "reformed-judaism" },
  { label: "Roman Catholicism", value: "roman-catholicism" },
  { label: "Russian Orthodox", value: "russian-orthodox" },
  { label: "Saint Thomas Christians (Syro‑Malabar)", value: "syro-malabar" },
  { label: "Salvation Army", value: "salvation-army" },
  { label: "Sanamahism", value: "sanamahism" },
  { label: "Santería", value: "santeria" },
  { label: "Scientology", value: "scientology" },
  { label: "Seicho‑no‑Ie", value: "seicho-no-ie" },
  { label: "Shaivism", value: "shaivism" },
  { label: "Shamanism", value: "shamanism" },
  { label: "Shia Islam", value: "shia-islam" },
  { label: "Shingon Buddhism", value: "shingon-buddhism" },
  { label: "Shinto", value: "shinto" },
  { label: "Sikhism", value: "sikhism" },
  { label: "Soka Gakkai", value: "soka-gakkai" },
  { label: "Spiritism (Kardecist)", value: "spiritism" },
  { label: "Sunni Islam", value: "sunni-islam" },
  { label: "Sufism", value: "sufism" },
  { label: "Swedenborgianism", value: "swedenborgianism" },
  { label: "Taiwanese Folk Religion", value: "taiwanese-folk-religion" },
  { label: "Taoism", value: "taoism" },
  { label: "Tenrikyo", value: "tenrikyo" },
  { label: "Thelema", value: "thelema" },
  { label: "Theravada Buddhism", value: "theravada-buddhism" },
  { label: "Tibetan Buddhism", value: "tibetan-buddhism" },
  {
    label: "Traditional Chinese Religion",
    value: "traditional-chinese-religion",
  },
  { label: "Unitarian Universalism", value: "unitarian-universalism" },
  { label: "United Church of Christ", value: "united-church-of-christ" },
  { label: "Urantia Fellowship", value: "urantia-fellowship" },
  { label: "Vaishnavism", value: "vaishnavism" },
  { label: "Vedanta Society", value: "vedanta-society" },
  { label: "Vodou", value: "vodou" },
  { label: "Wicca", value: "wicca" },
  { label: "World Mission Society Church of God", value: "wmscog" },
  { label: "Yazidism", value: "yazidism" },
