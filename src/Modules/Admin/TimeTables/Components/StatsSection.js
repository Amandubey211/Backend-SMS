...
export default function StatsSection({ counts, onTypeClick, activeType }) {
  return (
    <div className="mb-4">
      <div className="space-y-2">
        {TIMETABLE_TYPES.map((stat) => {
          // Use the counts from the redux prop, with a fallback to 0 if undefined.
          const count = counts && counts[stat.type] ? counts[stat.type] : 0;
