...
useEffect(() => {
  ...
  return (
    <div className="p-4 md:p-4 space-y-2 scroll-smooth overflow-y-auto h-full w-full ">
      ...
      >
        <ProtectedSection requiredPermission="studentfeecard">
        {/* Cards Section */}
        <StudentCardSection />
        </ProtectedSection>
        {/* Graph Section */}
        <ProtectedSection requiredPermission="studentfeegrapgh">
        <div className="w-full ">
          <StudentFeesGraph />
        </div>
        </ProtectedSection>
        {/* Summary Table */}
        <ProtectedSection requiredPermission="StudentFeesSummaryTable">
        <div className="w-full">
