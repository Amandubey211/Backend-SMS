          ...
          <div className="p-4  ">
            ...
            <div className="flex    justify-between ">
              <div className="flex gap-4">
                ...
                />
                <button className="p-2 border w-[100px] rounded bg-pink-100 text-center flex justify-center items-center  ">
              ...
              <div>
                <button
                  ...
                  className="p-2 border border-red-300 w-[100px] rounded bg-pink-100 text-center flex justify-center items-center  "
                >
                  <span className="font-semibold bg-gradient-to-r from-pink-500   to-purple-500 inline-block text-transparent bg-clip-text">
                    Add Notice
                  </span>
